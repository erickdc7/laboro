...
export const TECH_COLORS: Record<string, TechStyle> = {
  ...
  "Rust":         { dot: "#dea584", fg: "#8a5a2b", bg: "#f5ede6" },
  ".NET":         { dot: "#512bd4", fg: "#5a2d91", bg: "#f0eafb" },
  "C#":           { dot: "#9179c8", fg: "#4338ca", bg: "#eef0fb" },
...
const FALLBACK: TechStyle = { dot: "#9ca3af", fg: "#4b4b57", bg: "#f2f2f5" };

export function techStyle(technology: string): TechStyle {
  return TECH_COLORS[technology] ?? FALLBACK;
}

export const ALL_TECHNOLOGIES = Object.keys(TECH_COLORS);